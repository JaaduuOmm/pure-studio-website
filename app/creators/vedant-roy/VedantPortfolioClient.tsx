...
import { Github, Instagram, Mail, Award, Cpu, Code, NotebookText, DiscIcon as Discord } from "lucide-react"
...
export default function VedantPortfolioClient() {
  return (
    <div className="space-y-10">
      <motion.section
        className="text-center space-y-6 py-12 bg-gradient-to-r from-blue-500/5 to-green-500/5 rounded-xl shadow-inner"
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <motion.p className="mt-4 text-xl text-muted-foreground max-w-3xl mx-auto" variants={itemVariants}>
          Social Expert, Data Analysis, Information Collection, & Trend Search
        </motion.p>
      </motion.section>
        ...
        <motion.div variants={itemVariants}>
          <Card className="hover-3d shadow-lg shadow-primary/5">
            <CardContent className="p-6 text-muted-foreground">
              <p>
                Hi! I'm Vedant Roy, specializing in social expertise, data analysis, information collection, and trend
                research. My role involves understanding market dynamics, gathering crucial insights, and identifying
                emerging trends to inform our project strategies.
              </p>
              <p className="mt-4">
                I'm dedicated to ensuring our projects are not only technically sound but also resonate with our
                audience and align with current industry landscapes. I contribute to projects like PromptOS and PURE
                STUDIO by providing the foundational research and strategic direction needed for their success.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="hover-3d shadow-lg shadow-primary/5">
            <CardContent className="p-6 flex flex-wrap justify-center gap-4">
              <Button asChild variant="outline">
                <Link href="https://github.com/vsat-studios" target="_blank" rel="noreferrer">
                  <Github className="mr-2 h-4 w-4" />
                  GitHub
                </Link>
              </Button>
